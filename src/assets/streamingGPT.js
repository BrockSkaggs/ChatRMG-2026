window.dash_clientside = Object.assign({}, window.dash_clientside, {
    clientside: {
        streaming_GPT: async function streamingGPT(formatted_context, n_clicks, prompt, streaming_object_id, chat_history, model_select, conversation_id) {
            ...
            const response = await fetch("/streaming-chat", {
                ...
                body: JSON.stringify({ prompt, formatted_context, chat_history, model_select, conversation_id }),
            });
